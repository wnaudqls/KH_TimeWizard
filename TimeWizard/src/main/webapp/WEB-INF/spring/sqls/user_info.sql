...
ADD (USER_DISTINCT VARCHAR2(4000));
...
select count(todo_no) from user_todo where user_no = 3;
...
CREATE TABLE STOPWATCH( 
	...
	START_TIME VARCHAR2(500) NOT NULL, --STOPWATCH_START? START_TIME?
	END_TIME VARCHAR2(500) NOT NULL,  --STOPWATCH_END? END_TIME?
