...
public class GroupDto {
	...
	public GroupDto(int group_no, int group_su, int group_client, String user_id, String group_title, String group_content,
			String group_public, Date group_regdate, String group_hashtag, String group_pw, String group_anyone) {
