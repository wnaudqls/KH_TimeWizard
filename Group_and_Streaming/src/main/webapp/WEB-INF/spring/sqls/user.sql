...
INSERT INTO GROUP_INFO VALUES
(GROUP_INFO_SEQ.NEXTVAL, 'user','공개방2','누구나 쓸 수 있는 방','공개',SYSDATE,'공개방2',10, 0,NULL,'Y');	

INSERT INTO GROUP_INFO VALUES
(GROUP_INFO_SEQ.NEXTVAL, 'test','공개방3','누구나 쓸 수 있는 방','공개',SYSDATE,'공개방2',10, 0,NULL,'Y');

INSERT INTO GROUP_INFO VALUES
(GROUP_INFO_SEQ.NEXTVAL, 'ming','공개방4','누구나 쓸 수 있는 방','공개',SYSDATE,'공개방2',10, 0,NULL,'Y');
...
SELECT fl.FRIEND_NO, ui.USER_NO, ui.USER_ID ,ui.USER_NAME,
	ui.USER_PHOTO, ui.USER_ACTIVE, fl.STATUS
	FROM FRIEND_LIST fl, USER_INFO ui
	WHERE ui.USER_NAME = '테스트1'
	ORDER BY fl.FRIEND_NO
